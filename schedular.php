...
<head>
    ...
    <title>UB Go Student - Grades</title>
        ...
        <div class="sidebar">
            ...
            <nav>
                <ul class="nav-menu">
                    ...
                    <li class="nav-item">
                        <a href="schedular.php" class="nav-link active">
                            <span class="nav-icon"><img src="./assets/icons/filled-scheduler.svg" alt=""></span>
                            Schedular
                        </a>
                    </li>
                    <li class="nav-item">
...
<!-- Scheduler Mobile Section -->
        ...
        <div class="mobile-bottom-nav">
            ...
            <a href="schedular.php" class="nav-item-mobile active">
                <span><img src="./assets/icons/filled-scheduler.svg" alt=""></span>
                <span>Schedule</span>
            </a>
