...
<body>
    ...
    <div class="desktop-layout">
                ...
                <ul class="nav-menu">
                    ...
                    <li class="nav-item">
                        <a href="note.php" class="nav-link active">
                            <span class="nav-icon"><img src="./assets/icons/filled-note.svg" alt=""></span>
                            Notes
                        </a>
                    </li>
                </ul>
        ...
        <div class="main-content">
            ...
            <!-- Grades Section -->
             <iframe class="grade-iframe" src=" http://localhost:3000" frameborder="0"></iframe>
    ...
    <div class="mobile-layout">
        ...
        <div class="mobile-main">
             ...
             <iframe class="grade-iframe-mobile" src=" http://localhost:3000" frameborder="0" height="100vh"></iframe>
        ...
        <div class="mobile-bottom-nav">
            ...
            <a href="note.php" class="nav-item-mobile active">
                <span><img src="./assets/icons/filled-note.svg" alt=""></span>
                <span>Notes</span>
            </a>
        </div>
    </div>
